...
# Port 22 redirects to Cowrie (2222) and admin port (2223) is exclusive  
sudo nmap -sV -Pn -p 22,2222,2223 13.48.42.241
...
for i in {1..5}; do ssh -i ~/.ssh/wrong_key.pem ubuntu@13.48.42.241 -p 2223; done  
...
\begin{figure}[h!]
\centering
    \includegraphics[width=0.7\linewidth]{doc/img/annex_b_listing_2.png}
\end{figure}
...
ssh -o PubkeyAuthentication=no -o PreferredAuthentications=password ubuntu@13.48.42.241 -p 2223  
\end{lstlisting}  
\
